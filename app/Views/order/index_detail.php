...
.shop-tracking-status .image-order-status.active{box-shadow:0px 0px 10px 0px #eff1ef}

.shop-tracking-status .image-order-status.active .status{color:#cf7400;text-shadow:0px 0px 1px #777}
					...
					<div class="side-app">
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">History Data Order</a></li>
        ...
        <div class="well">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    <span class="prefix label label-success"><b>Order Date:</b></span>
                    <span><b><?=$view[0]['OrderDate']?></b></span>
                </li> 

                <li class="list-group-item">
                    <span class="prefix label label-success"><b>Order ID:</b></span>
                    <span><b><?=$view[0]['OrderID']?></b></span>
                </li> 
              ...
              <tbody>
                ...
                <?php 
                   ...
                   ?> 
                    ...
                    <td><?=$view[$a]['NameProduk']?></td>
                    <td class="text-right"><?=number_format($view[$a]['PricePoint'])?></td>
                    <td class="text-right"><?=number_format($view[$a]['Qty'])?></td> 
                ...
                <tr>
                    ...
                    <td colspan="5"><b>No detailed order data found...</b></td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="text-right form-control form-control-sm" name="totalpoin" id="totalpoin" size="5" type="text" value="<?=number_format($viewtotal['PricePoint'])?>">
                    </td>
                    <td>
                        <input class="text-right form-control form-control-sm" name="totalqty" id="totalqty" size="5" type="text" value="<?=number_format($viewtotal['Qtyc'])?>">
                    </td>
            ...
            <div class="order-status">
                ...
                <div class="image-order-status image-order-status-new active img-circle">
                    ...
                    <span class="status">Accepted in System</span>
               ...
               <form action='<?=base_url();?>/order/updatestatus/<?=$view[0]['OrderID'];?>' method="post">
             ...
             <div class="order-status">
                ...
                <div class="image-order-status image-order-status-active active img-circle">
                   ...
                   <div class="custom-control custom-checkbox">
                       ...
                       <?php if($view[0]['StatusInprogress'] === '1') { ?>
                            <input type="checkbox" class="custom-control-input" id="inproggres" name="inproggres" value="1" checked>
                            <label class="custom-control-label" for="inproggres" style="color: #cf7412;">In progress</label>
                       <?php }else{  ?>
                            <input type="checkbox" class="custom-control-input" id="inproggres" name="inproggres" value="1" >
                            <label class="custom-control-label" for="inproggres" style="color: #cf7412;">In progress</label>
                       <?php } ?>
                ...
                <div class="image-order-status image-order-status-intransit active img-circle">
                    ...
                    <?php if($view[0]['StatusShipped'] === '1') { ?>
                        <input type="checkbox" class="custom-control-input" id="shipped" name="shipped" value="1" checked>
                        <label class="custom-control-label" for="shipped" style="color: #cf7412;">Shipped</label>
                        <?php }else{  ?>
                            <input type="checkbox" class="custom-control-input" id="shipped" name="shipped" value="1" >
                            <label class="custom-control-label" for="shipped" style="color: #cf7412;">Shipped</label>
                            <?php } ?>
                    </div>
                ...
                <div class="image-order-status image-order-status-delivered active img-circle">
                    ...
                    <?php if($view[0]['StatusDelivered'] === '1') { ?>
                        <input type="checkbox" class="custom-control-input" id="delivered" name="delivered" value="1" checked>
                        <label class="custom-control-label" for="delivered" style="color: #cf7412;">Delivered</label>
                        <?php }else{  ?>
                            <input type="checkbox" class="custom-control-input" id="delivered" name="delivered" value="1" >
                            <label class="custom-control-label" for="delivered" style="color: #cf7412;">Delivered</label>
                            <?php } ?>
                    </div>
                ...
                <div class="image-order-status image-order-status-completed active img-circle">
                    ...
                    <div class="custom-control custom-checkbox">
                    <?php if($view[0]['StatusCompleted'] === '1') { ?>
                        <input type="checkbox" class="custom-control-input" id="completed" name="completed" value="1" checked>

                        <label class="custom-control-label" for="completed" style="color: #cf7412;">Completed</label>
                        <?php }else{  ?>
                            <input type="checkbox" class="custom-control-input" id="completed" name="completed" value="1">
