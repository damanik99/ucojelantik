    ...
    <div class="side-app">
        ...
        <div class="page-header">
            ...
            <div class="ml-auto pageheader-btn">
                <a href="<?=base_url()?>/redemption/updatewrongprogram" class="btn btn-warning btn-icon text-white mr-2">
                    <span>
                        <i class="fa fa-upload"></i>
                    </span> UPDATE WRONG PROGRAM
                </a>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action='<?=base_url();?>/redemption/uploadRedemption' method="post"
                            ...
                            <div id="formUser">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <a href="<?=base_url()?>/custom/downloadTemplate/template_redemption.csv"
