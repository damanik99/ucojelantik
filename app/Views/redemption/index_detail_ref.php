                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        <div>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">History Data Order Tracking SAP</a></li>
                        ...
                        <div class="ml-auto pageheader-btn">
                            <a href="<?=base_url()?>/redemption/index" class="btn btn-primary btn-icon text-white mr-2">
                                <span>
                                    <i class="fe fe-plus"></i>
                                </span> Back To Data Table
                            </a>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header bg-primary br-tr-3 br-tl-3">
                                    <h3 class="card-title">DATA HISTORY TRACKING SAP</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tabledata"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th class="wd-15p">No Tracking</th>
                                                    <th class="wd-15p">No Reference</th>
                                                    <th class="wd-15p">counter name</th>
                                                    <th class="wd-15p">No AWB</th>
                                                    <th class="wd-15p">pod status code</th>
                                            ...
                                            <tbody>
                                                <tr>
													...
													?>
                                                    <td><?=$view[$a]['tracking_id']?></td>
                                                    <td><?=$view[$a]['reference_no']?></td>
                                                    <td><?=$view[$a]['counter_name']?></td>
                                                    <td><?=$view[$a]['awb_no']?></td>
                                                    <td><?=$view[$a]['pod_status_code']?></td>
                                                    <td><?=$view[$a]['description']?></td>
                                                </tr>
                                                <?php } }else{ ?>
                                                <tr>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header bg-primary br-tr-3 br-tl-3">
                                    <h3 class="card-title">Data Image POD</h3>
                                </div>
                                <?php //echo var_dump($view);exit; 
                                    
                                ?>
                                <?php foreach ($view as $views) { ?>
                                <?php //$dataview = json_decode($views, true); 
                                    echo var_dump($views);exit;
                                } ?>
                                <div class="card-body text-center">
                                    <table id="tabledata"
                                        class="table table-bordered border-t0 key-buttons text-nowrap w-100">
                                        <?php foreach ($view as $views) { ?>
                                        <?php echo var_dump($views);exit; ?>
                                        <th>
                                            <a href="<?=$view[0]['pod_photo']?>" class="pop" target="_blank">
                                                Clik View Image & Image Signature
                                            </a>
                                        </th>
                                        <th>
                                            <a href="<?=$view[0]['pod_camera']?>" class="pop" target="_blank">
                                                Clik View Image
                                            </a>
                                        </th>
                                        <th>
                                            <a href="<?=$view[0]['pod_signature']?>" class="pop" target="_blank">
                                                Clik View Image Signature
                                            </a>
                                        </th>
                                        <?php } ?>
                                    </table>
