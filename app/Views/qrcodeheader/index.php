                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        ...
                        <div class="ml-auto pageheader-btn">
                            <a href="<?=base_url()?>/qrcodeheader/uploadqr"
                                class="btn btn-success btn-icon text-white mr-2">
                                <span>
                                    <i class="fa fa-upload"></i>
                                </span>UPLOAD
                            </a>
                            <!-- <a href="<?=base_url()?>/item/report" class="btn btn-cyan">
                                <span>
                    ...
                    <div class="alert alert-info" role="alert">
                        <i class="fa fa-info-circle mr-2" aria-hidden="true"></i>Create Qrcode click
                                        ...
                                        <table id="exportexample"
                                            ...
                                            <tbody>
                                                <tr>
													...
													if(!empty($dataqrcode))
													{
														for($a=0 ; $a<count($dataqrcode) ; $a++)
														{ 
															// $id = $dataqrcode[$a]['qrbarcodepdf_id'];
													?>
                                                    <td><?=$dataqrcode[$a]['code']?></td>
                                                    <td><?=$dataqrcode[$a]['redemption_number']?></td>
                                                    <td><?=$dataqrcode[$a]['item']?></td>
                                                    <td><?=$dataqrcode[$a]['qrcode']?></td>
                                                    <td><?=$dataqrcode[$a]['type']?></td>
