                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-primary">
                                    <h3 class="card-title"><i class="fa fa-info-circle"></i> PROGRAM INFORMATION</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered text-nowrap w-100">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">CLIENT NAME</th>
                                                    <td>&nbsp;<?php echo $views['client_name']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">TIME START</th>
                                                    <td>&nbsp;<?php echo $views['time_start']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">TIME STOP</th>
                                                    <td>&nbsp;<?php echo $views['time_stop']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">FREQUENCY</th>
                                                    <td>&nbsp;<?php echo $views['frequency']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">INCLUDE SUNDAY</th>
                                                    <td>&nbsp;<?php echo $views['include_sunday']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">INCLUDE SATURDAY</th>
                                                    <td>&nbsp;<?php echo $views['include_saturday']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">CONTACT NAME</th>
                                                    <td>&nbsp;<?php echo $views['contact_name']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">CONTACT PHONE</th>
                                                    <td>&nbsp;<?php echo $views['contact_phone']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">START DATE</th>
                                                    <td>&nbsp;<?php echo $views['start_date']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">END DATE</th>
                                                    <td>&nbsp;<?php echo $views['end_date']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">BUDGET</th>
                                                    <td>&nbsp;<?php echo $views['budget']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">HANDLING CHARGE</th>
                                                    <td>&nbsp;<?php echo $views['handling']; ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE ACTIVITY</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_activity'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE ATTENDANCE</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_attendance'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE INBOUND</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_inbound'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE DISTRIBUTION</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_distribution'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE DISPLAY</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_display'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE REDEMPTION</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_redemption'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE SELLING</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_selling'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }else
                                                        {
                                                ...
                                                <tr>
                                                    <th width="300px" style="color: white;">MODULE TRAINING</th>
                                                    <td>&nbsp;<?php  ?>
                                                        <?php 
                                                        if($views['module_training'] == "1") 
                                                        {
                                                            echo 'Yes';
                                                        }
                                                        else
                                    ...
                                    <a href="<?= base_url() ?>/program" type="button" class="btn btn-warning"><i
