                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <form action='<?=base_url();?>/channel/uploadChannel' method="post"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <a href="<?=base_url()?>/custom/downloadTemplate/template_channel.csv"
                                            ...
                                            <div class="form-group">
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="replaceexist" value="replaceexist">
