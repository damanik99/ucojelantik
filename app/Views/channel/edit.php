                    ...
                    <div class="page-header">
                        <div>
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Channel Update</li>
                            </ol>
                        </div>
                    </div>
                    <!-- PAGE-HEADER END -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form action='<?=base_url();?>/channel/edit/<?php echo $channel['organization_id'];?>'
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status_id">
                                                        ...
                                                        <?php foreach($status_name as $row): ?>
                                                        <option value="<?php echo $row['status_id'];?>"
                                                            <?php if($row['name'] == $channel['status_name']) echo " selected" ?>>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="code"
                                                        value="<?php echo $codes ?>" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Channel Name <required>*</required>
                                                    </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="member_of"
                                                        value="<?= $channel['member_of'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-show-search" id="ownership"
                                                        name="ownership">
                                                        <option value="">-- Select One --</option>
                                                        <option value="ownership"
                                                            <?php if($channel['ownership'] == "ownership") echo " selected" ?>>
                                                            Ownership</option>
                                                        <option value="perusahaan"
                                                            <?php if($channel['ownership'] == "perusahaan") echo " selected" ?>>
                                                            Perusahaan</option>
                                                        <option value="perorangan"
                                                            <?php if($channel['ownership'] == "perorangan") echo " selected" ?>>
                                                            Perorangan</option>
                                                    </select>
                                                    <?php  ?>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Open Since</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text">
                                                                <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                                            </div>
                                                        </div><input type="text" class="form-control" name="open_since"
                                                            id="open_since" placeholder="YYYY-MM-DD"
                                                            value="<?php echo $channel['open_since'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class=" col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-show-search" id="ownership"
                                                        ...
                                                        <option value="">-- Select One --</option>
                                                        <option value="S"
                                                            <?php if($channel['size'] == "S") echo " selected" ?>>
                                                            S</option>
                                                        <option value="M"
                                                            <?php if($channel['size'] == "M") echo " selected" ?>>
                                                            M
                                                        </option>
                                                        <option value="L"
                                                            <?php if($channel['size'] == "L") echo " selected" ?>>
                                                            L
                                                        </option>
                                                        <option value="XL"
                                                            <?php if($channel['size'] == "XL") echo " selected" ?>>
                                                            XL
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="building_name"
                                                        value="<?php echo $channel['building_name'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="floor_number"
                                                        value="<?php echo $channel['floor_number'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="street_number"
                                                        value="<?php echo $channel['street_number'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="country"
                                                        value="<?php echo $channel['country'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="state"
                                                        value="<?php echo $channel['state'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">city <required>*</required>
                                                    </label>
                                                    <select class="form-control select2-show-search" id="city_id"
                                                        ...
                                                        <option value="<?php echo $row['city_id'];?>"
                                                            <?php if($row['city_name'] == $channel['channel_city']) echo " selected" ?>
                                                            id="city_id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="postal_code"
                                                        value="<?php echo $channel['post_code'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="latitude"
                                                        value="<?php echo $channel['latitude'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="longitude"
                                                        value="<?php echo $channel['longitude'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="owner_name"
                                                        value="<?php echo $channel['ownership'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="contact_name"
                                                        value="<?php echo $channel['contact_phone'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="tax_name"
                                                        value="<?php echo $channel['tax_name'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="tax_number"
                                                        value="<?php echo $channel['tax_number'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="account_bank"
                                                        value="<?php echo $channel['account_bank'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="account_name"
                                                        value="<?php echo $channel['account_name'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="account_number"
                                                        value="<?php echo $channel['account_number'];?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" type="text" name="note1" rows="3"
                                                        placeholder="Write a large text here ..."><?php echo $channel['description'];?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="form-actions text-center mt-5">
                                            <a class="btn btn-warning mr-1" href="<?=base_url()?>/channel"
