            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary br-tr-3 br-tl-3">
                        <h3 class="mb-0 card-title">UPDATE POINT ACCUMULATION</h3>
                    </div>
                    <?= session()->getFlashdata('error'); ?>
                    <form id="claimpoint"
                        action=<?=base_url('/pointaccumulation/edit/'.$pointaccumulation->point_accumulation_id);?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control select2-show-search" id="member_full_name"
                                        ...
                                        <option value="<?= $members['member_id'] ?>"
                                            <?php if ($members["member_id"] == $pointaccumulation->member_id) echo " selected" ?>>
                                            <?= $members['full_name']; ?>
                                        </option>
                                        <?php endforeach;?>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code"
                                        value="<?= $pointaccumulation->code ?>" required="">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control select2-show-search" id="member_full_name" name="item"
                                        ...
                                        <option value="<?= $programitems['program_item_id'] ?>"
                                            <?php if($programitems["program_item_id"] == $pointaccumulation->program_item_id) echo 'selected' ?>>
                                            <?= $programitems['item'] ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <div class="wd-200 mg-b-30">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                ...
                                                value="<?= $pointaccumulation->claim_date ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="invoice_number"
                                        value="<?= $pointaccumulation->invoice_number ?>" required="">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="wd-200 mg-b-30">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="invoice_date"
                                                id="invoice_date" placeholder="YYYY-MM-DD"
                                                value="<?= $pointaccumulation->invoice_date ?>" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                ...
                if (response.status === 'error') {
                    ...
                    setTimeout(function() {
                        window.location.href = response
                            .redirect; // Redirect ke halaman view
                    }, 2000);
                }
