                ...
                <div class="side-app">
                    ...
                    <div class="page-header">
                        ...
                        <div class="ml-auto pageheader-btn">
                            <a href="<?=base_url()?>/merchant/add" class="btn btn-primary btn-icon text-white">
                                <span>
                    ...
                    <div class="alert alert-info" role="alert">
                        <i class="fa fa-info-circle mr-2" aria-hidden="true"></i>Create new data merchant, click
                        button<i class="fe fe-plus"></i> create.<br>
                        <i class="fa fa-info-circle mr-2" aria-hidden="true"></i>Create some new data merchant, click
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php 
														...
														for($a=0 ; $a<count($datamerchant) ; $a++){ 
															$id = $datamerchant[$a]['merchant_id'];
													?>
                                                    <td><?=$datamerchant[$a]['company']?></td>
                                                    <td><?=$datamerchant[$a]['name']?></td>
                                                    <td><?=$datamerchant[$a]['phone']?></td>
                                                    <td><?=$datamerchant[$a]['email']?></td>
                                                    <td><?=$datamerchant[$a]['city']?></td>
                                                    <td>
                                                        <a href="<?=base_url()?>/merchant/edit/<?=$id?>"
                                                            class="badge badge-pill badge-success" title="Edit"><i
                                                                class="fa fa-pencil"></i></a>
                                                        <a href="<?=base_url()?>/merchant/view/<?=$id?>"
                                                ...
                                                <?php } }else{ ?>
                                                <tr>
                                                    <td colspan="5"><b>Tidak ada data merchant di temukan...</b></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
