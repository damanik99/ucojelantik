                ...
                <div class="side-app">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                <div class="card-header bg-primary">
                                    <h3 class="card-title">DATA DETAIL SALES UPLOAD</h3>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    if(!empty($dataDetail))
                                                    {
                                                        ...
                                                        { 
                                                            $id = $dataDetail[$a]['salesupload_detail_id'];
                                                ?>
                                                    <td><?=$dataDetail[$a]['code']?></td>
                                                    <td><?=$dataDetail[$a]['item_name']?></td>
                                                    <td><?=$dataDetail[$a]['organization_from']?></td>
                                                    <td><?=$dataDetail[$a]['organization_to']?></td>
                                                    <td><?=$dataDetail[$a]['unique_number']?></td>
                                                    <td>
                                                        <a href="<?=base_url()?>/salesuploaddetail/view/<?=$id?>"
