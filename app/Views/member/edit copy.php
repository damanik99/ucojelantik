                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header bg-primary br-tr-3 br-tl-3">
                                    <h3 class="mb-0 card-title">MEMBER UPDATE</h3>
                                </div>
                                <form action='<?=base_url();?>/member/saveedit/<?php echo $member['member_id'];?>'
                                    method="post">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="code"
                                                        value="<?php echo $member['code'];?>" required="" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="channel"
                                                        value="<?php echo $member['channel'];?>">
                                                    <input type="hidden" name="organization_id"
                                                        value="<?php echo $member['organization_id'];?>">
                                                    <?php 
													}
													else
													{ ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">First Name <required>*</required></label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="gender">
														...
														if($member['gender']) 
														{ ?>
                                                        <option value='<?php echo $member['gender'] ?>'>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2-show-search"
                                                        ...
                                                        <?php 
														if($member['identity_type_id'])
														{ ?>
                                                        <option value="<?php echo $member['identity_type_id'] ?>">
                                                            <?php echo $member['identity_type_name'] ?>
                                                        </option>
                                                        <?php 
														}
														else
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="placeofbird"
                                                        value="<?php echo $member['place_of_birth'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="mobile_phone"
                                                        value="<?php echo $member['mobile_phone'] ?>">
                                                    <?php 
                                                    }else
                                                    { ?>
                                                    <input class="form-control" type="text" name="mobile_phone"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="persnoal_email"
                                                        value="<?php echo $member['personal_email'] ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="domicile_address" rows="3"
                                                        placeholder=""><?php echo $member['domicile_address'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="postal_code"
                                                        value="<?php echo $member['postal_code'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="company_name"
                                                        value="<?php echo $member['company_name'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="company_phone"
                                                        value="<?php echo $member['company_phone'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    if($member['company_fax'])
                                                    { ?>
                                                    <input class="form-control" type="text" name="company_fax"
                                                        value="<?php echo $member['company_fax'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    if($member['account_bank'])
                                                    { ?>
                                                    <input class="form-control" type="text" name="account_bank"
                                                        value="<?php echo $member['account_bank'] ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="account_number"
                                                        value="<?php echo $member['account_number'] ?>">
