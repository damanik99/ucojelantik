...
class MemberApi extends ResourceController
{
	...
	public function dataMember()
	{
		...
		{
			$sql = "SELECT a.member_id, first_name AS full_name, `gender`, `mobile_phone`, a.program_id, b.name AS program, domicile_address AS address, 
			personal_email AS email, point_awarded, point_redeem, point_expire, point_balance, a.note1, a.note2, a.created_date, a.created_by
			FROM member a
			...
			foreach ($result as $models)
			{
				$dataArr[] = [
					...
					'program_name' => $models['program'],
					'address' => $models['address'],
					'email' => $models['email'],
					'point_awarded' => $models['point_awarded'],
					'point_redeem' => $models['point_redeem'],
					'point_expire' => $models['point_expire'],
					'point_balance' => $models['point_balance'],
					'note1' => $models['note1'],
